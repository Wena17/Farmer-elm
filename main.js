...
var $author$project$Main$exampleProduct = {id: 1, imgUrl: '/assets/strawberry.jpg', name: 'Strawberry', price: 350, prodType: 'fruit', quantity: 7, unit: 'kg'};
...
var $author$project$Main$init = {
	products: $elm$core$Maybe$Just(
		_List_fromArray(
			[$author$project$Main$exampleProduct, $author$project$Main$exampleProduct2])),
	user: $author$project$Main$Guest
};
